...
const Users: User[] = [
  ...
  {
    title: 'Cross-chain Interoperability-tools',
    description: 'CLI to make common operations around Cross-chain Interoperability files simpler',
    preview: null,
...
export const Tags: {[type in TagType]: Tag} = {
  ...
  i18n: {
    ...
    description: translate({
      ...
      id: 'showcase.tag.Cross-chain Interoperability.description',
    }),
    color: '#127f82',
  },
